...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        ' -- Konfigurasi Panel Tengah (The White Card) --
        ...
        ' -- Judul Utama (Aesthetic Purple) --
        lblWelcome.Font = New Font("Segoe UI Semibold", 20.0F, FontStyle.Bold)
        lblWelcome.ForeColor = Color.FromArgb(162, 155, 254)
        ...
        lblSubTitle.Text = "siapkan imajinasimu, yuk login dulu!"
        lblSubTitle.TextAlign = ContentAlignment.MiddleCenter

        ' -- Label Username ✨ --
        lblUserTag.Font = New Font("Segoe UI", 9.0F, FontStyle.Bold)
        lblUserTag.ForeColor = Color.FromArgb(255, 159, 243)
        ...
        lblPassTag.ForeColor = Color.FromArgb(255, 159, 243)
        ...
        ' -- Tombol Login (Mint Green) --
        btnMasuk.BackColor = Color.FromArgb(85, 239, 196)
        ...
        ' -- Konfigurasi Form Utama (Soft Sky Blue) --
